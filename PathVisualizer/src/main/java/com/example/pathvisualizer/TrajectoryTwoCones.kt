...
//        Right(3)
    ...
    private fun Left(dest: Int) {
        ...
        val parkingOne = Pose2d(59.0, -13.0, Math.toRadians(0.0))
        ...
        var trajectoryToParkingOne = TrajectoryBuilder(trajectoryHighBackward.end(), Math.toRadians(-60.0), combinedConstraints)
            .splineToSplineHeading(parkingOne, Math.toRadians(5.0))
            .build();
        ...
        var trajectoryToParkingThree = TrajectoryBuilder(trajectoryHighBackward.end(), Math.toRadians(-90.0), combinedConstraints)
            .splineToSplineHeading(parkingThree, Math.toRadians(180.0))
            .build();
    ...
    private fun Right(dest: Int) {
        ...
        val midJunction = Pose2d(10.0, -45.0, Math.toRadians(90.0))
        ...
        var trajectoryToJunction = TrajectoryBuilder(rightHome, Math.toRadians(-90.0), combinedConstraints)
