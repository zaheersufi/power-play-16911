...
public class midAllianceLeft extends LinearOpMode
{
    ...
    private final Pose2d otwTwo = new Pose2d(20, 13, Math.toRadians(0));
    private final Pose2d parkingTwo = new Pose2d(36, 12, Math.toRadians(0));
    private final Pose2d otw1One = new Pose2d(20, 13, Math.toRadians(0));
